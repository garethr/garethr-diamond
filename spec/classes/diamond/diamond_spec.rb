  ...
  supported_osfamily.each do |osfamily|
    describe "on #{osfamily}" do
      ...
      context 'no parameters' do
        ...
        it { should create_class('diamond::python')}
      ...
      context 'with enabling manage_python' do
        ...
        if osfamily != 'Solaris'
          ...
          it { should contain_package('python-devel') } if osfamily == 'RedHat'
          it { should contain_package('python-dev') } if osfamily == 'Debian'
          it { should contain_package('gcc') }
        end
        if osfamily == 'Solaris'
          it { should contain_package('pip') }
          it { should contain_package('solarisstudio-122') }
        end
      end
    end
